...
<!--       <h2 class="speaker-subheader">talk</h2>
 ...
 -->
      ...
      <p class="copy">In this two days format we’ll experience the different formats, working around real business problems.
      ...
      <ul class="copy-list">
      <li>Design-Level EventStorming: leveraging collaborative modelling to sketck bullet-proof model quickly.</li>
