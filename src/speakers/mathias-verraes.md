...
<div class="container section featured-speaker">
  <div class="row">
    ...
    <p class="copy">SThe software industry keeps moving towards more message-oriented architectures. These require different ways of reasoning about system design, domain modelling, evolutionary architectures.</p>
