...
<div class="container homepage--intro-text">
    <div class="row">
        ...
        <h2>Workshops</h2>  For those who would like to dig deeper, we are also bringing back pre-conference workshops (2-days, 16 hours each) on Tuesday and Wednesday, March 13-14.
        <p>Visit the Registration page for conference tickets and separate workshop tickets.</p>
    </div>
