			...
			<div id="div3" class="targetDiv day-div">
					...
					<div class="row time-row  colored-cell-row last-colored-row">
						...
						<div class="col-sm-2 details details-colored details-gold">
							...
							<p class="talk-title">Know the Flow! Events, Commands and Long-Running Services.</p>
						</div> <!-- details -->
						<div class="col-sm-2 details details-colored details-green">
					...
					<div class="row time-row  colored-cell-row last-colored-row">
						...
						<div class="col-sm-2 details details-colored details-gold">
							...
							<p class="talk-title">Visualizing Your Event Storm in New Ways</p>
						</div> <!-- details -->
						<div class="col-sm-2 details details-colored details-green">
				...
				<div id="div4" class="targetDiv day-div">
					...
					<div class="row time-row  last-colored-row">
						...
						<div class="col-sm-2 details details-colored details-gold">
							...
							<p class="talk-title">All Our Aggregates Are Wrong</p>
						</div> <!-- details -->
						<div class="col-sm-2 details details-colored details-green">
							<h4><a href="../speakers/stefan-hofer.html">Stefan Hofer</a> &amp; <a href="../speakers/henning-schwentner.html">Henning Schwentner</a></h4>
							<p class="talk-title">How Domain Storytelling Shaped Our View of Bounded Contexts</p>
						</div> <!-- details -->
						<div class="col-sm-2 details details-colored details-purple">
							<h4><a href="../speakers/yves-reynhout.html">Yves Reynhout</a></h4>
							<p class="talk-title">Projections Explained</p>
						</div> <!-- details -->
						<!--<div class="col-sm-2 details details-colored details-blue">
							<h4>Creative Space</h4>							
						</div>--> <!-- details -->
					...
					<div class="row time-row  last-colored-row">
						...
						<div class="col-sm-2 details details-colored details-gold">
							...
							<p class="talk-title">Communication is Everyting; Especially While Pairing (Survival Guide)</p>
						</div> <!-- details -->
						<div class="col-sm-2 details details-colored details-green">
							<h4><a href="../speakers/paul-rayner.html">Paul Rayner</a></h4>
							<p class="talk-title">Modeling Team Flow</p>
						</div> <!-- details -->
						<div class="col-sm-2 details details-colored details-purple">
							<h4><a href="../speakers/yves-reynhout.html">Yves Reynhout</a></h4>
							<p class="talk-title">Projections Explained</p>
