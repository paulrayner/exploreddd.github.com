	    ...
	    <h1 class="section-header">Schedule</h1>
			...
			<div id="div2" class="targetDiv kickoff-div">
				...
				<div class="row time-row ">
					...
					<div class="col-sm-10 details details-wide top-border ">
			...
			<div id="div3" class="targetDiv day-div">
					...
					<div class="row time-row  last-colored-row">
						...
						<div class="col-sm-2 details details-colored details-gold">
							...
							<p class="talk-title"><a href="../speakers/david-boike.html">Microservices and Distributed Monoliths</a></p>
						</div> <!-- details -->
					...
					<div class="row time-row  last-colored-row">
						...
						<div class="col-sm-2 details details-colored details-gold">
							...
							<p class="talk-title"><a href="../speakers/allard-buijze.html">The Invconveniences of Event Sourcing</a></p>
						</div> <!-- details -->
						<div class="col-sm-2 details details-colored details-green">
					...
					<div class="row time-row  colored-cell-row last-colored-row">
						...
						<div class="col-sm-2 details details-colored details-gold">
							...
							<p class="talk-title"><a href="../speakers/martin-schimak.html">Know the Flow! Events, Commands and Long-Running Services.</a></p>
						</div> <!-- details -->
						<div class="col-sm-2 details details-colored details-green">
