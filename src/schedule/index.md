				...
				<div id="div4" class="targetDiv day-div">
					...
					<div class="row time-row custom-grid-column-widths last-colored-row">
						...
						<div class="col-sm-2 details details-colored details-gold">
							...
							<p class="talk-title">fat controller CQRS diet</p>
						</div> <!-- details -->
						<div class="col-sm-2 details details-colored details-green">
							<h4><a href="../speakers/nicolo-pignatelli.html">Nicolò Pignatelli
</a></h4>
							<p class="talk-title">Metaphor Driven Design</p>
						</div> <!-- details -->
						<div class="col-sm-2 details details-colored details-purple">
					...
					<div class="row time-row custom-grid-column-widths last-colored-row">
						...
						<div class="col-sm-2 details details-colored details-gold">
							<h4><a href="../speakers/jean-francois-cloutier.html">JEAN-FRANÇOIS CLOUTIER</a></h4>
							<p class="talk-title">modeling the mind of an autonomous robot</p>
						</div> <!-- details -->
						<div class="col-sm-2 details details-colored details-green">
							<h4><a href="../speakers/alberto-brandolini.html">Alberto Brandolini</a></h4>
							<p class="talk-title">optimized for what? delivery is not the real goal</p>
						</div> <!-- details -->
						<div class="col-sm-2 details details-colored details-purple">
