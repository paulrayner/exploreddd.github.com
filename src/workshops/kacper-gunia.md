    ...
    <div class="row">
      <div class="col-xs-12 col-sm-2">
            ...
            <div class="col-xs-12 col-sm-8 content">
                <h1>[SOLD OUT] Domain-Driven Design Modeling Process: From Problem to Solution Space</h1>
                <p><span class="speaker-name">Kacper Gunia</span>
                <span class="duration">November 2-5, 2020<br>9:00 AM - 12:30 PM (MST)</span></p>
