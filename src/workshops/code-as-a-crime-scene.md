    ...
    <div class="row">
      <div class="col-xs-12 col-sm-2">
        ...
        <div class="col-xs-12 col-sm-10 workshop-list"> 
            ...
            <p class="copy">Hands-on, bring your own laptop. The practical exercises use Git and CodeScene. Make sure you have a Git client and a Java run-time, version 8, installed on your laptop if you want to analyze your organizations private repositories.</p>
